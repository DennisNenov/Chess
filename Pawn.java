...
public class Pawn extends Piece {
	...
	public void refreshCache () 
	{
		...
		_scopeCache.set(2, new Object[]{0,2,false,false,false,(_rowvalue == 6 && _color.equals(_color2) && ((_snapshot[1][2]).equals("Empty")) )});
		_scopeCache.set(3, new Object[]{0,-2,false,false,false,(_rowvalue == 1 && _color.equals(_color1) && ((_snapshot[3][2]).equals("Empty")) )});
